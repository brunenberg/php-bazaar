                ...
                <div class="bg-white rounded-lg shadow-md overflow-hidden">
                    ...
                    <div class="p-4 flex justify-between items-center">
                        ...
                        <form action="{{route('account/remove-favorite')}}" method="POST">
                            ...
                            <button type="submit" value="Verwijderen" class="bg-red-500 text-white px-4 py-2 rounded-lg w-full hover:bg-red-600 focus:outline-none focus:ring-4 focus:ring-red-300">Verwijderen</button>
                        </form>
                    </div>
                </div>
            </div>
