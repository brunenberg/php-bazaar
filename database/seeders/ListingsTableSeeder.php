...
class ListingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $listings = [
            ['title' => 'Sony Camera', 'description' => 'Camera is in uitstekende staat, perfect voor hobbyfotografen en professionals. Wordt geleverd met extra lenzen en draagtas. Ophalen of verzenden mogelijk.', 'image' => 'sony_camera.jpg', 'company_id' => 1, 'user_id' => null, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ...
            ['title' => 'MacBook Pro 2020', 'description' => 'Zo goed als nieuwe MacBook Pro 2020 te koop. Slechts enkele maanden oud en nauwelijks gebruikt. Inclusief oplader en originele doos.', 'image' => 'macbook.jpeg', 'company_id' => null, 'user_id' => 3, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ['title' => 'Mountainbike', 'description' => 'Specialized mountainbike te koop. Maat M, geschikt voor avontuurlijke ritten in de natuur. Inclusief accessoires zoals fietshelm en fietscomputer.', 'image' => 'mountainbike.jpg', 'company_id' => 1, 'user_id' => null, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ...
            ['title' => 'Design Eettafel', 'description' => 'Moderne design eettafel met glazen blad en metalen poten. Afmetingen: 150cm x 90cm x 75cm. Past perfect in een eigentijdse eetkamer.', 'image' => 'design_eettafel.jpeg','company_id' => null, 'user_id' => 3, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ...
            // Extra listings
            ['title' => 'Vintage Fiets', 'description' => 'Een klassieke vintage fiets in goede staat. Perfect voor stadsritten of om toe te voegen aan je collectie.', 'image' => 'vintage_fiets.jpg', 'company_id' => null, 'user_id' => 3, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ...
            ['title' => 'Vintage Horloge', 'description' => 'Een prachtig vintage horloge met een uniek design. Een must-have voor horlogeliefhebbers en verzamelaars.', 'image' => 'vintage_horloge.jpg', 'company_id' => null, 'user_id' => 3, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ['title' => 'Kunstbloemenboeket', 'description' => 'Een levensecht kunstbloemenboeket dat het hele jaar door kleur en vreugde brengt. Geen onderhoud nodig!', 'image' => 'kunstbloemenboeket.jpg', 'company_id' => 1, 'user_id' => null, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
            ...
            ['title' => 'Fitnessapparatuur', 'description' => 'Een complete set fitnessapparatuur voor thuisgebruik. Train je hele lichaam zonder de deur uit te hoeven.', 'image' => 'fitnessapparatuur.jpg', 'company_id' => 1, 'user_id' => null, 'bidding_allowed' => rand(0, 1), 'price' => rand(2, 200) * 0.5],
        ];
