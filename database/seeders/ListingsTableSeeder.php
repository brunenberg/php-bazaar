...
class ListingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $listings = [
            ['title' => 'Sony Camera', 'description' => 'Camera is in uitstekende staat, perfect voor hobbyfotografen en professionals. Wordt geleverd met extra lenzen en draagtas. Ophalen of verzenden mogelijk.', 'image' => 'sony_camera.jpg', 'company_id' => 1, 'user_id' => null, 'bidding_allowed' => 0, 'price' => rand(2, 200) * 0.5, 'type' => 'verhuur', 'rental_days' => '5', 'condition' => '100', 'wear_speed' => 'normal'],
            ...
            // Extra listings
            ['title' => 'Vintage Fiets', 'description' => 'Een klassieke vintage fiets in goede staat. Perfect voor stadsritten of om toe te voegen aan je collectie.', 'image' => 'vintage_fiets.jpg', 'company_id' => null, 'user_id' => 3, 'bidding_allowed' => 0, 'price' => rand(2, 200) * 0.5, 'type' => 'verhuur', 'rental_days' => '5', 'condition' => '100', 'wear_speed' => 'normal'],
